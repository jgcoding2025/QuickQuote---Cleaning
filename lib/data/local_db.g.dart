...
class QuoteRow extends DataClass implements Insertable<QuoteRow> {
  ...
  factory QuoteRow.fromJson(
    ...
    return QuoteRow(
      ...
      householdMembersJson: serializer.fromJson<String>(
        json['householdMembersJson'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'householdMembersJson': serializer.toJson<String>(householdMembersJson),
    };
  }
...
class QuotesCompanion extends UpdateCompanion<QuoteRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (householdMembersJson.present) {
      map['household_members_json'] = Variable<String>(
